...
// Type: GameFramework.GameFrameworkFunc`11
...
{
  /// <summary>封装一个方法，该方法具有十个参数，并返回 TResult 参数所指定的类型的值。</summary>
  ...
  public delegate TResult GameFrameworkFunc<in T1, in T2, in T3, in T4, in T5, in T6, in T7, in T8, in T9, in T10, out TResult>(
    T1 arg1,
    T2 arg2,
    T3 arg3,
    T4 arg4,
