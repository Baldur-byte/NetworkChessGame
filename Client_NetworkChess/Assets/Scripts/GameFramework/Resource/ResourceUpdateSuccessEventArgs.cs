...
// Type: GameFramework.Resource.ResourceUpdateSuccessEventArgs
...
namespace GameFramework.Resource
{
  ...
  {
    /// <summary>初始化资源更新成功事件的新实例。</summary>
    ...
    public static ResourceUpdateSuccessEventArgs Create(
      string name,
      string downloadPath,
      string downloadUri,
      int length,
    ...
    {
      ResourceUpdateSuccessEventArgs successEventArgs = ReferencePool.Acquire<ResourceUpdateSuccessEventArgs>();
