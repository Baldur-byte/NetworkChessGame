...
// Type: GameFramework.Resource.ResourceUpdateChangedEventArgs
...
namespace GameFramework.Resource
{
  ...
  {
    /// <summary>初始化资源更新改变事件的新实例。</summary>
    ...
    public static ResourceUpdateChangedEventArgs Create(
      string name,
      string downloadPath,
      string downloadUri,
      int currentLength,
    ...
    {
      ResourceUpdateChangedEventArgs changedEventArgs = ReferencePool.Acquire<ResourceUpdateChangedEventArgs>();
      changedEventArgs.Name = name;
      changedEventArgs.DownloadPath = downloadPath;
      changedEventArgs.DownloadUri = downloadUri;
      changedEventArgs.CurrentLength = currentLength;
      changedEventArgs.CompressedLength = compressedLength;
      return changedEventArgs;
    }

    /// <summary>清理资源更新改变事件。</summary>
