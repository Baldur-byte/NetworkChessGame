...
// Type: GameFramework.ObjectPool.ObjectPoolBase
...
{
  /// <summary>对象池基类。</summary>
  public abstract class ObjectPoolBase
  {
    private readonly string m_Name;

    /// <summary>初始化对象池基类的新实例。</summary>
    ...
    public ObjectPoolBase(string name) => this.m_Name = name ?? string.Empty;

    /// <summary>获取对象池名称。</summary>
    public string Name => this.m_Name;

    /// <summary>获取对象池完整名称。</summary>
    public string FullName => new TypeNamePair(this.ObjectType, this.m_Name).ToString();
