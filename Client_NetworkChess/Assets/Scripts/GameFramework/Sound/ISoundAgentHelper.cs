...
// Type: GameFramework.Sound.ISoundAgentHelper
...
namespace GameFramework.Sound
{
  ...
  public interface ISoundAgentHelper
  {
    ...
    /// <summary>重置声音代理辅助器。</summary>
    void Reset();

    /// <summary>设置声音资源。</summary>
