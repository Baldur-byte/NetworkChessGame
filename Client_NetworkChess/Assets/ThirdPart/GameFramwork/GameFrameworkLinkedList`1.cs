...
// Type: GameFramework.GameFrameworkLinkedList`1
...
namespace GameFramework
{
    ...
    ICollection
  {
    ...
    public GameFrameworkLinkedList<T>.Enumerator GetEnumerator() => new GameFrameworkLinkedList<T>.Enumerator(this.m_LinkedList);
    ...
    public struct Enumerator : IEnumerator<T>, IDisposable, IEnumerator
    {
      ...
      internal Enumerator(LinkedList<T> linkedList) => this.m_Enumerator = linkedList != null ? linkedList.GetEnumerator() : throw new GameFrameworkException("Linked list is invalid.");
