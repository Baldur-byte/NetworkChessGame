...
// Type: GameFramework.Resource.ILoadResourceAgentHelper
...
namespace GameFramework.Resource
{
  ...
  public interface ILoadResourceAgentHelper
  {
    ...
    /// <summary>通过加载资源代理辅助器开始异步读取资源文件。</summary>
    ...
    /// <summary>通过加载资源代理辅助器开始异步读取资源二进制流。</summary>
    /// <param name="fullPath">要加载资源的完整路径名。</param>
    ...
    /// <summary>通过加载资源代理辅助器开始异步将资源二进制流转换为加载对象。</summary>
    /// <param name="bytes">要加载资源的二进制流。</param>
    void ParseBytes(byte[] bytes);

    /// <summary>通过加载资源代理辅助器开始异步加载资源。</summary>
