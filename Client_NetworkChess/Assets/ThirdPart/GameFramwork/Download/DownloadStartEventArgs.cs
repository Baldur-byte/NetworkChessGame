...
// Type: GameFramework.Download.DownloadStartEventArgs
...
namespace GameFramework.Download
{
  ...
  public sealed class DownloadStartEventArgs : GameFrameworkEventArgs
  {
    ...
    public static DownloadStartEventArgs Create(
      int serialId,
      string downloadPath,
      string downloadUri,
      long currentLength,
