...
// Type: GameFramework.GameFrameworkFunc`4
...
{
  /// <summary>封装一个方法，该方法具有三个参数，并返回 TResult 参数所指定的类型的值。</summary>
  ...
  public delegate TResult GameFrameworkFunc<in T1, in T2, in T3, out TResult>(
    T1 arg1,
    T2 arg2,
    T3 arg3);
}
