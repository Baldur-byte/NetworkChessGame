...
// Type: GameFramework.ObjectPool.ObjectInfo
...
namespace GameFramework.ObjectPool
{
  ...
  public struct ObjectInfo
  {
      ...
      int spawnCount)
    {
      ...
      this.m_CustomCanReleaseFlag = customCanReleaseFlag;
      this.m_Priority = priority;
      this.m_LastUseTime = lastUseTime;
    ...
    /// <summary>获取对象自定义释放检查标记。</summary>
    public bool CustomCanReleaseFlag => this.m_CustomCanReleaseFlag;

    /// <summary>获取对象的优先级。</summary>
    public int Priority => this.m_Priority;

    /// <summary>获取对象上次使用时间。</summary>
    public DateTime LastUseTime => this.m_LastUseTime;
